...
const char parachuteStr[] PROGMEM = "PARACHUTE";
const char wideScreenStr[] PROGMEM = "WIDE SCREEN";
const char gameAStr[] PROGMEM = "GAME A";
const char gameBStr[] PROGMEM = "GAME B";
