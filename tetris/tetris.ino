...
#ifdef HACKVISION
#define STARTMSG "Press Button"
#include <ButtonController.h>
#endif

//BOARD_X and NXT_X must be divisible by 8!!!!!!!!
#define BOARD_X (24)
#define BOARD_Y (0)
#define NXT_X (0)
#define NXT_Y (8)
...
void setup() {
  ...
  TV.printPGM(28,20,PSTR("Arduino"));
  TV.printPGM(32,29,PSTR("TETRIS"));
  TV.select_font(font6x8);
  TV.delay(500);
...
//modify this to render the game TVout rendering is defined here.
